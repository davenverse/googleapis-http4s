...
lazy val cloudFirestoreV1 =
  mkProject("cloud-firestore-v1", "proto-google-cloud-firestore-v1", "3.21.5")
    .dependsOn(common)
...
lazy val cloudPubsubV1 =
  mkProject("cloud-pubsub-v1", "proto-google-cloud-pubsub-v1", "1.112.1")
    .dependsOn(common)
...
lazy val cloudSpannerV1 =
  mkProject("cloud-spanner-v1", "proto-google-cloud-spanner-v1", "6.69.0")
    .dependsOn(common)
