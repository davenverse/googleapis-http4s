...
lazy val cloudBigQueryConnectionV1 =
  mkProject("cloud-bigqueryconnection-v1", "proto-google-cloud-bigqueryconnection-v1", "2.45.0")
...
lazy val cloudBigQueryDataTransferV1 =
  mkProject("cloud-bigquerydatatransfer-v1", "proto-google-cloud-bigquerydatatransfer-v1", "2.43.0")
  .dependsOn(common)
...
lazy val cloudBigQueryReservationV1 =
  mkProject("cloud-bigqueryreservation-v1", "proto-google-cloud-bigqueryreservation-v1", "2.44.0")
  .dependsOn(common)
...
lazy val cloudDatastreamV1 =
  mkProject("cloud-datastream-v1", "proto-google-cloud-datastream-v1", "1.42.0")
  .dependsOn(common)
...
lazy val cloudMemcacheV1 =
  mkProject("cloud-memcache-v1", "proto-google-cloud-memcache-v1", "2.43.0")
    .dependsOn(common)
...
lazy val cloudRedisV1 =
  mkProject("cloud-redis-v1", "proto-google-cloud-redis-v1", "2.46.0")
    .dependsOn(common)
...
lazy val cloudTraceV2 =
  mkProject("cloud-trace-v2", "proto-google-cloud-trace-v2", "2.43.0")
    .dependsOn(common)
