...
lazy val java =
  mkProject("java", "protobuf-java", "3.24.2", "com.google.protobuf")
...
lazy val cloudAlloyDb =
  mkProject("cloud-alloydb", "proto-google-cloud-alloydb-v1", "0.12.0")
  .dependsOn(common)

lazy val cloudBigQueryConnectionV1 =
  mkProject("cloud-bigqueryconnection-v1", "proto-google-cloud-bigqueryconnection-v1", "2.25.0")
  .dependsOn(common, iamV1)

lazy val cloudBigQueryDataPolicyV1 =
  mkProject("cloud-bigquerydatapolicy-v1", "proto-google-cloud-bigquerydatapolicy-v1", "0.20.0")
  .dependsOn(common, iamV1)

lazy val cloudBigQueryDataTransferV1 =
  mkProject("cloud-bigquerydatatransfer-v1", "proto-google-cloud-bigquerydatatransfer-v1", "2.23.0")
  .dependsOn(common)

lazy val cloudBigQueryMigrationV2 =
  mkProject("cloud-bigquerymigration-v2", "proto-google-cloud-bigquerymigration-v2", "0.26.0")
  .dependsOn(common)

lazy val cloudBigQueryReservationV1 =
  mkProject("cloud-bigqueryreservation-v1", "proto-google-cloud-bigqueryreservation-v1", "2.24.0")
  .dependsOn(common)

lazy val cloudBigQueryStorageV1 =
  mkProject("cloud-bigquerystorage-v1", "proto-google-cloud-bigquerystorage-v1", "2.41.1")
  .dependsOn(common)

lazy val cloudBigtableV2 =
  mkProject("cloud-bigtable-v2", "proto-google-cloud-bigtable-v2", "2.27.0")
  .dependsOn(common)

lazy val cloudDatastreamV1 =
  mkProject("cloud-datastream-v1", "proto-google-cloud-datastream-v1", "1.22.0")
  .dependsOn(common)

lazy val cloudFirestoreV1 =
  mkProject("cloud-firestore-v1", "proto-google-cloud-firestore-v1", "3.14.0")
    .dependsOn(common)

lazy val cloudKmsV1 =
  mkProject("cloud-kms-v1", "proto-google-cloud-kms-v1", "0.117.0")
    .dependsOn(common)

lazy val cloudMemcacheV1 =
  mkProject("cloud-memcache-v1", "proto-google-cloud-memcache-v1", "2.23.0")
    .dependsOn(common)

lazy val cloudPubsubV1 =
  mkProject("cloud-pubsub-v1", "proto-google-cloud-pubsub-v1", "1.106.2")
    .dependsOn(common)

lazy val cloudRedisV1 =
  mkProject("cloud-redis-v1", "proto-google-cloud-redis-v1", "2.26.0")
    .dependsOn(common)

lazy val cloudSpannerV1 =
  mkProject("cloud-spanner-v1", "proto-google-cloud-spanner-v1", "6.45.3")
    .dependsOn(common)
...
lazy val cloudTraceV2 =
  mkProject("cloud-trace-v2", "proto-google-cloud-trace-v2", "2.23.0")
    .dependsOn(common)
