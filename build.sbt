...
lazy val cloudAlloyDb =
  mkProject("cloud-alloydb", "proto-google-cloud-alloydb-v1", "0.6.0")
  .dependsOn(common)
...
lazy val cloudBigQueryDataPolicyV1 =
  mkProject("cloud-bigquerydatapolicy-v1", "proto-google-cloud-bigquerydatapolicy-v1", "0.14.0")
  .dependsOn(common, iamV1)
...
lazy val cloudBigQueryMigrationV2 =
  mkProject("cloud-bigquerymigration-v2", "proto-google-cloud-bigquerymigration-v2", "0.20.0")
  .dependsOn(common)

lazy val cloudBigQueryReservationV1 =
  mkProject("cloud-bigqueryreservation-v1", "proto-google-cloud-bigqueryreservation-v1", "2.18.0")
  .dependsOn(common)
...
lazy val cloudDatastreamV1 =
  mkProject("cloud-datastream-v1", "proto-google-cloud-datastream-v1", "1.16.0")
  .dependsOn(common)
