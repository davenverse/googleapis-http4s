...
lazy val cloudBigtableV2 =
  mkProject("cloud-bigtable-v2", "proto-google-cloud-bigtable-v2", "2.28.0")
  .dependsOn(common)
...
lazy val cloudMemcacheV1 =
  mkProject("cloud-memcache-v1", "proto-google-cloud-memcache-v1", "2.28.0")
    .dependsOn(common)

lazy val cloudPubsubV1 =
  mkProject("cloud-pubsub-v1", "proto-google-cloud-pubsub-v1", "1.107.8")
    .dependsOn(common)
...
lazy val cloudTraceV2 =
  mkProject("cloud-trace-v2", "proto-google-cloud-trace-v2", "2.28.0")
    .dependsOn(common)
