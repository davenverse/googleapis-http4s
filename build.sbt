...
lazy val java =
  mkProject("java", "protobuf-java", "3.23.1", "com.google.protobuf")

lazy val common =
  mkProject("common", "proto-google-common-protos", "2.19.0")
  .dependsOn(java)
...
lazy val cloudBigQueryStorageV1 =
  mkProject("cloud-bigquerystorage-v1", "proto-google-cloud-bigquerystorage-v1", "2.37.0")
  .dependsOn(common)
...
lazy val cloudPubsubV1 =
  mkProject("cloud-pubsub-v1", "proto-google-cloud-pubsub-v1", "1.105.12")
    .dependsOn(common)
...
lazy val cloudSpannerV1 =
  mkProject("cloud-spanner-v1", "proto-google-cloud-spanner-v1", "6.42.1")
    .dependsOn(common)
...
lazy val iamV1 =
  mkProject("iam-v1", "proto-google-iam-v1", "1.14.0").dependsOn(common)
