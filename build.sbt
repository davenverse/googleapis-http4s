...
lazy val cloudAlloyDb =
  mkProject("cloud-alloydb", "proto-google-cloud-alloydb-v1", "0.19.0")
  .dependsOn(common)

lazy val cloudBigQueryConnectionV1 =
  mkProject("cloud-bigqueryconnection-v1", "proto-google-cloud-bigqueryconnection-v1", "2.32.0")
  .dependsOn(common, iamV1)

lazy val cloudBigQueryDataPolicyV1 =
  mkProject("cloud-bigquerydatapolicy-v1", "proto-google-cloud-bigquerydatapolicy-v1", "0.27.0")
  .dependsOn(common, iamV1)
...
lazy val cloudBigQueryMigrationV2 =
  mkProject("cloud-bigquerymigration-v2", "proto-google-cloud-bigquerymigration-v2", "0.33.0")
  .dependsOn(common)

lazy val cloudBigQueryReservationV1 =
  mkProject("cloud-bigqueryreservation-v1", "proto-google-cloud-bigqueryreservation-v1", "2.31.0")
  .dependsOn(common)

lazy val cloudBigQueryStorageV1 =
  mkProject("cloud-bigquerystorage-v1", "proto-google-cloud-bigquerystorage-v1", "2.45.0")
  .dependsOn(common)

lazy val cloudBigtableV2 =
  mkProject("cloud-bigtable-v2", "proto-google-cloud-bigtable-v2", "2.29.1")
  .dependsOn(common)
...
lazy val cloudFirestoreV1 =
  mkProject("cloud-firestore-v1", "proto-google-cloud-firestore-v1", "3.15.3")
    .dependsOn(common)

lazy val cloudKmsV1 =
  mkProject("cloud-kms-v1", "proto-google-cloud-kms-v1", "0.124.0")
    .dependsOn(common)
...
lazy val cloudRedisV1 =
  mkProject("cloud-redis-v1", "proto-google-cloud-redis-v1", "2.33.0")
    .dependsOn(common)
