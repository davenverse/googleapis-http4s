...
lazy val common =
  mkProject("common", "proto-google-common-protos", "2.17.0")
  .dependsOn(java)
...
lazy val cloudBigtableV2 =
  mkProject("cloud-bigtable-v2", "proto-google-cloud-bigtable-v2", "2.22.0")
  .dependsOn(common)
...
lazy val iamV1 =
  mkProject("iam-v1", "proto-google-iam-v1", "1.12.0").dependsOn(common)
