...
lazy val common =
  mkProject("common", "proto-google-common-protos", "2.39.1")
  .dependsOn(java)
...
lazy val cloudBigQueryStorageV1 =
  mkProject("cloud-bigquerystorage-v1", "proto-google-cloud-bigquerystorage-v1", "3.5.1")
  .dependsOn(common)

lazy val cloudBigtableV2 =
  mkProject("cloud-bigtable-v2", "proto-google-cloud-bigtable-v2", "2.39.3")
  .dependsOn(common)
...
lazy val cloudKmsV1 =
  mkProject("cloud-kms-v1", "proto-google-cloud-kms-v1", "0.138.0")
    .dependsOn(common)
...
lazy val cloudPubsubV1 =
  mkProject("cloud-pubsub-v1", "proto-google-cloud-pubsub-v1", "1.111.6")
    .dependsOn(common)
...
lazy val cloudSpannerV1 =
  mkProject("cloud-spanner-v1", "proto-google-cloud-spanner-v1", "6.67.0")
    .dependsOn(common)
...
lazy val iamV1 =
  mkProject("iam-v1", "proto-google-iam-v1", "1.34.1").dependsOn(common)
